...
# 词区间（固定区间，避免重复获取）
AUTO_OFFSET     = True        # True: 自动用现有 words.json 的长度作为 OFFSET
OFFSET          = 0            # Resource处理0-999词汇
...
PERM_FAILED_FILE= "failed_permanent.json"     # 永久失败词（单一文件，追加，不清理）
FUNCTION_WORDS_FILE = "function_words_custom.txt"  # 外部自定义白名单

# DeepSeek
MODEL_NAME      = "deepseek-chat"
DEEPSEEK_API_KEY = "sk-2ef1778620364d54ac7e1b1135f8e344"  # DeepSeek API Key
