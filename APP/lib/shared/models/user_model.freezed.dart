...
abstract class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String? avatarPath});
}
...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl(
      {required this.id, required this.name, this.avatarPath});
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, avatarPath: $avatarPath)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final String? avatarPath}) = _$UserModelImpl;
...
abstract class $UserStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool hasUser, UserModel? user});
...
class _$UserStateImpl implements _UserState {
  const _$UserStateImpl({this.hasUser = false, this.user});
  ...
  @override
  String toString() {
    return 'UserState(hasUser: $hasUser, user: $user)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, hasUser, user);
...
abstract class _UserState implements UserState {
  const factory _UserState({final bool hasUser, final UserModel? user}) =
      _$UserStateImpl;
...
abstract class $UpdateProfileRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, String? avatarPath});
}
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  const _$UpdateProfileRequestImpl({this.name, this.avatarPath});
  ...
  @override
  String toString() {
    return 'UpdateProfileRequest(name: $name, avatarPath: $avatarPath)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, avatarPath);
...
abstract class _UpdateProfileRequest implements UpdateProfileRequest {
  const factory _UpdateProfileRequest(
      {final String? name,
      final String? avatarPath}) = _$UpdateProfileRequestImpl;
